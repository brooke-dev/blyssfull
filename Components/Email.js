...
function Newsletter() {
  return (
    <section>
      <div className="bg-violet-300 max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="relative bg-gray-900 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl overflow-hidden" data-aos="zoom-y-out">
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                <h3 className="h3 text-white mb-2">Want to stay up to date?</h3>
                <p className="text-gray-300 text-lg mb-6">Get emails straight to your inbox with our weekly newsletter.</p>
                ...
                <form className="w-full lg:w-auto">
                  ...
                  <p className="text-sm text-gray-400 mt-3">Sign Up Today!</p>
                </form>
              </div>
